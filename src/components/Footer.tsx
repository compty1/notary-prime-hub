    ...
    <footer className="border-t border-sidebar-border bg-sidebar text-sidebar-foreground/60 print:hidden" role="contentinfo" aria-label="Site footer">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-5">
          ...
          <div>
            <h4 className="mb-3 font-heading text-sm font-semibold text-sidebar-foreground">Platform</h4>
          ...
          <div>
            <h4 className="mb-3 font-heading text-sm font-semibold text-sidebar-foreground">Legal</h4>
            <div className="space-y-2 text-sm">
