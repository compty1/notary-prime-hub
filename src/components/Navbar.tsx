...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md h-24 flex items-center print:hidden" aria-label="Main navigation" role="navigation">
      ...
      <div className="container mx-auto flex items-center justify-between px-4">
        <Link to="/" className="flex items-center gap-3">
          <Logo size="sm" showText theme="dark" className="[&_img]:h-[120px] [&_img]:w-[120px] [&_span]:text-5xl" />
        </Link>
