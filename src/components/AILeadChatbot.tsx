            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 space-y-2">
              ...
              <div className="space-y-1.5">
                ...
                <div>
                  ...
                  <Input className="h-7 text-xs" type="email" placeholder="you@example.com" value={captureData.email} onChange={(e) => setCaptureData(p => ({ ...p, email: e.target.value }))} autoComplete="email" />
                </div>
                <div>
                  <Label className="text-[10px]">Phone</Label>
                  <Input className="h-7 text-xs" type="tel" placeholder="(614) 555-1234" value={captureData.phone} onChange={(e) => setCaptureData(p => ({ ...p, phone: e.target.value }))} autoComplete="tel" />
                </div>
              </div>
