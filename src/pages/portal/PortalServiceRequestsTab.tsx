...
import { FileText, Clock, CheckCircle, AlertTriangle, Download } from "lucide-react";
...
export default function PortalServiceRequestsTab({ serviceRequests }: Props) {
  ...
  const filtered = statusFilter === "all" ? serviceRequests : serviceRequests.filter(r => r.status === statusFilter);
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {req.deliverable_url && (
                          <a href={req.deliverable_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-sm text-primary hover:underline mt-1">
