      ...
      <div className="flex min-h-screen items-center justify-center bg-[#fcfcfc] px-4">
        <div className="w-full max-w-md rounded-[24px] border border-gray-100 bg-white p-8 shadow-sm">
          <div className="flex flex-col items-center text-center">
            ...
            <Link to="/login">
              <Button className="rounded-xl bg-[hsl(43, 74%, 49%)] text-white hover:bg-[#ca9a06] shadow-[3px_3px_0px_#212529]">Go to Sign In</Button>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full rounded-xl bg-[hsl(43, 74%, 49%)] text-white font-bold hover:bg-[#ca9a06] shadow-[3px_3px_0px_#212529] h-11" disabled={submitting || !acceptTerms}>
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col items-center justify-center bg-[#212529] p-12 text-white">
        <div className="max-w-sm text-center space-y-8">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[24px] bg-[hsl(43, 74%, 49%)]/20">
            <Shield className="h-10 w-10 text-[hsl(43, 74%, 49%)]" />
          </div>
