...
export default function ServiceDetail() {
  ...
  if (loading) {
    return (
      <PageShell>
        <div className="container mx-auto max-w-4xl px-4 py-12" aria-busy="true">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-start gap-4">
            ...
            <div>
              <div className="mb-2 flex flex-wrap items-center gap-2">
                ...
                <Badge variant="outline" className="text-primary-foreground/90 border-white/40 text-xs">
              ...
              <div className="mt-4 flex items-center gap-3">
                <Badge variant="outline" className="text-primary-foreground/80 border-white/20 text-base px-3 py-1">{formatPrice(service)}</Badge>
                {/* Gap #44: Share button */}
                <Button size="sm" variant="outline" className="border-white/20 text-primary-foreground/80 hover:bg-background/10" onClick={handleShare}>
