          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div><Label>Support Email</Label><Input type="email" value={editValues.support_email || ""} onChange={(e) => updateValue("support_email", e.target.value)} autoComplete="email" placeholder="support@notar.com" /></div>
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input type="email" value={editValues.admin_notification_email || ""} onChange={(e) => updateValue("admin_notification_email", e.target.value)} autoComplete="email" placeholder="admin@notar.com" />
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="branding" className="space-y-6">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                {[
                  { key: "social_facebook", label: "Facebook", placeholder: "https://facebook.com/notar" },
                  { key: "social_twitter", label: "Twitter / X", placeholder: "https://x.com/notar" },
                  { key: "social_linkedin", label: "LinkedIn", placeholder: "https://linkedin.com/company/notar" },
                  { key: "social_instagram", label: "Instagram", placeholder: "https://instagram.com/notar" },
                  { key: "social_youtube", label: "YouTube", placeholder: "https://youtube.com/@notar" },
                  { key: "social_google_business", label: "Google Business Profile", placeholder: "https://g.page/notar" },
                ].map(s => (
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div><Label>Business Email</Label><Input type="email" value={editValues.notary_email || ""} onChange={(e) => updateValue("notary_email", e.target.value)} autoComplete="email" placeholder="contact@notar.com" /></div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div><Label>Reply-To Email</Label><Input type="email" value={editValues.reply_to_email || ""} onChange={(e) => updateValue("reply_to_email", e.target.value)} autoComplete="email" placeholder="noreply@notar.com" /></div>
