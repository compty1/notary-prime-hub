...
export const SERVICE_FLOWS: ServiceFlow[] = [
  {
    ...
    steps: [
      ...
      { name: "Service Pre-Qualifier", description: "Check eligibility before proceeding", route: "/book", component: "ServicePreQualifier", implemented: true },
      ...
      { name: "Pre-Signing Checklist", description: "Required items checklist before signing", route: "/book", component: "PreSigningChecklist", implemented: true },
      { name: "Signer Checklist", description: "Signer preparation verification", route: "/book", component: "SignerChecklist", implemented: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "SignNow Document Upload", description: "Upload document to SignNow for e-signing", route: undefined, component: "signnow", implemented: true, automations: [{ type: "webhook", name: "signnow", description: "Uploads document via SignNow API" }] },
      { name: "SignNow Invite Sent", description: "SignNow sends signing invitation email to signer", route: undefined, component: "signnow-webhook", implemented: true, automations: [{ type: "webhook", name: "signnow-webhook", description: "Captures invite.sent event" }], emailTemplateKey: "signnow_invite" },
      { name: "SignNow Signer Views Document", description: "Signer opens the document link from SignNow", route: undefined, component: "signnow-webhook", implemented: true, automations: [{ type: "webhook", name: "signnow-webhook", description: "Captures document.viewed event" }] },
      { name: "SignNow Document Signed", description: "Signer completes e-signature via SignNow", route: undefined, component: "signnow-webhook", implemented: true, automations: [{ type: "webhook", name: "signnow-webhook", description: "Captures document.signed event" }] },
      { name: "SignNow Completion Email", description: "SignNow sends completion notification to all parties", route: undefined, component: "signnow-webhook", implemented: true, automations: [{ type: "email", name: "signnow-webhook", description: "External email from SignNow" }], emailTemplateKey: "signnow_completion" },
      { name: "SignNow Document Download", description: "Download completed signed document from SignNow", route: undefined, component: "SignNowStatusPanel", implemented: true },
      { name: "Notarization Certificate", description: "Generate notarization certificate document", route: undefined, component: "NotarizationCertificate", implemented: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Client Feedback", description: "Post-appointment feedback submission", route: "/portal", component: "ClientFeedbackForm", implemented: true },
    ],
  },
  {
    id: "business-portal",
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Bulk Document Upload", description: "Multi-file batch upload", route: "/portal", component: "BulkDocumentUpload", implemented: true },
      ...
      { name: "Document Translation", description: "AI-powered document translation", route: undefined, component: "TranslationPanel", implemented: true },
      { name: "Document Explanation", description: "AI document explanation for clients", route: undefined, component: "explain-document", implemented: true },
      { name: "Document Detection", description: "AI document type classification", route: undefined, component: "detect-document", implemented: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "AI Build Analyst", description: "AI-powered build analysis chat", route: "/admin/build-tracker", component: "AIAnalystTab", implemented: true },
