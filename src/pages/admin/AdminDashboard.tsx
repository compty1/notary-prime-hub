...
const sidebarGroups = [
  {
    ...
    items: [
      ...
      { title: "Shop Orders", url: "/admin/shop-orders", icon: ShoppingBag, adminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Catalog Audit", url: "/admin/service-catalog-audit", icon: ShieldCheck, adminOnly: true },
