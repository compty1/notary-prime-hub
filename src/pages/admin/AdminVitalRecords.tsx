...
const statusColors: Record<string, string> = { intake: "bg-warning/10 text-warning", submitted: "bg-info/10 text-info", processing: "bg-purple-100 text-purple-800", received: "bg-success/10 text-success", delivered: "bg-muted text-gray-800" };
