...
const actionColors: Record<string, string> = {
  appointment_status_changed: "bg-info/10 text-info",
  appointment_created_by_admin: "bg-info/10 text-info",
  journal_entry_created: "bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary",
  document_status_changed: "bg-warning/10 text-warning",
  ...
  payment_marked_paid: "bg-success/10 text-success",
  apostille_status_changed: "bg-info/10 text-info",
  correspondence_sent: "bg-info/10 text-info",
  verification_created: "bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300",
  verification_revoked: "bg-destructive/10 text-destructive",
  client_profile_updated: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-300",
  business_verification_changed: "bg-warning/10 text-warning",
