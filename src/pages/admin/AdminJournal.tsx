            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-border/50 p-3 space-y-3">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div><Label>Platform Fees ($)</Label><Input type="number" step="0.01" value={form.platform_fees} onChange={(e) => setForm({ ...form, platform_fees: e.target.value })} <div><Label>Platform Fees ($)</Label><Input type="number" step="0.01" value={form.platform_fees} onChange={(e) => setForm({ ...form, platform_fees: e.target.value })} placeholder="KBA + OneNotary fees" /></div> /></div>
