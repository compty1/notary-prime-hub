...
import {
  ...
  ExternalLink, FileSignature, Clock, Star, Facebook, Linkedin, Twitter,
} from "lucide-react";
...
export default function NotaryPage() {
    ...
    return (
      <PageShell>
        <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center">
          <h1 className="text-3xl font-bold">Notary Page Not Found</h1>
          <p className="text-muted-foreground">This notary page doesn't exist or hasn't been published yet.</p>
  ...
  return (
    <PageShell>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-center gap-2 md:justify-start">
                ...
                {page.is_featured && (
                  <Badge className="gap-1 bg-amber-500 text-white">
                    <Star className="h-3 w-3" /> Featured Notary
                  </Badge>
                )}
              </div>
      ...
      {/* Bottom CTA */}
      <section className="py-12" style={{ background: `linear-gradient(135deg, ${themeColor}15, ${themeColor}05)` }}>
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-2xl font-bold">Ready to Get Started?</h2>
          <p className="mt-2 text-muted-foreground">
            Schedule your notarization appointment today. Professional, secure, and compliant.
          </p>
