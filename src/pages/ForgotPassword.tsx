...
export default function ResetPassword() {
 ...
 <span className={`text-xs font-medium ${strength <= 2 ? "text-destructive" : strength <= 3 ? "text-warning" : "text-primary"}`}>
 ...
 <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" required placeholder="you@example.com" className="mt-1 rounded-xl border-border bg-card" />
 </div>
