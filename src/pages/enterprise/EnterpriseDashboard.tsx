...
const tools = [
  ...
  { title: "KYC/OFAC Search", description: "OFAC sanctions list screening", icon: ShieldCheck, path: "/admin/enterprise/kyc-search", color: "text-destructive" },
  { title: "IP/Patent Hub", description: "USPTO patent search", icon: Globe, path: "/admin/enterprise/ip-hub", color: "text-purple-500" },
  { title: "Certificate Generator", description: "ORC-compliant notarial certificates", icon: Award, path: "/admin/enterprise/certificates", color: "text-warning" },
  { title: "Exhibit Stamper", description: "PDF exhibit label stamping", icon: FileEdit, path: "/admin/enterprise/exhibit-stamper", color: "text-success" },
  { title: "Digital Vault", description: "RON audit trails & hash verification", icon: FolderOpen, path: "/admin/enterprise/digital-vault", color: "text-info" },
  { title: "VIN Decoder", description: "NHTSA VIN decode & odometer forms", icon: Truck, path: "/admin/enterprise/auto-fleet", color: "text-warning" },
  { title: "Lien Center", description: "Construction lien & waiver management", icon: Hammer, path: "/admin/enterprise/lien-center", color: "text-destructive" },
  { title: "Trust Scheduler", description: "Estate trust assets & Schedule A", icon: ScrollText, path: "/admin/enterprise/trust-scheduler", color: "text-info" },
  ...
  { title: "Immigration Hub", description: "Visa bulletin & translation affidavits", icon: Globe, path: "/admin/enterprise/immigration-hub", color: "text-success" },
