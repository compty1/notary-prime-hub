        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial="hidden" animate="visible">
            ...
            <motion.p variants={fadeUp} custom={2} className="mx-auto max-w-2xl text-primary-foreground/70">
              More secure than traditional notarization, accepted in all 50 states, and available from anywhere. Learn why RON is the smarter choice. NotarDex uses <strong>SignNow</strong> as our certified RON platform — including built-in MISMO-compliant KBA.
            </motion.p>
          </motion.div>
        </div>
      </section>
