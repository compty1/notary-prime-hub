...
import { Heart, Shield, Clock, FileCheck, Users, Monitor, ArrowRight, CheckCircle, Phone, BedDouble } from "lucide-react";

const features = [
  { icon: BedDouble, title: "Bedside & ICU Notarization", desc: "Mobile notary services directly at the patient's bedside — including ICU, emergency, and recovery rooms. No patient transport required." },
  { icon: Shield, title: "HIPAA-Aware Process", desc: "Our notarization workflow is designed with healthcare privacy in mind. We never access, copy, or retain protected health information." },
  { icon: Heart, title: "Healthcare Directives & POA", desc: "Advance directives, living wills, healthcare powers of attorney, and DNR acknowledgments notarized on-site when time is critical." },
  { icon: Clock, title: "Urgent & After-Hours Availability", desc: "Same-day and after-hours notarization for time-sensitive medical documents. Available evenings and weekends for critical situations." },
  { icon: Users, title: "Witness Coordination", desc: "We provide impartial witnesses when required by Ohio law (ORC §2133.02) for healthcare directives and living wills." },
  { icon: Monitor, title: "Remote Notarization Option", desc: "For patients who can participate via video, Ohio-authorized RON sessions allow notarization without an in-person visit." },
];
    ...
    <PageShell>
              ...
              <div className="flex flex-wrap gap-3">
                <Link to="/book">
                  <Button size="lg" className="rounded-full px-8">
                    Schedule Bedside Visit <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link to="/services">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-xl text-muted-foreground">
              Specialized notary services designed for the unique needs of hospitals, nursing facilities, and healthcare providers.
            </p>
          </div>
          ...
          <div className="grid items-start gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mb-6 text-muted-foreground">
                From emergency advance directives to routine administrative forms, we handle the full range of
                healthcare-related documents that require notarization under Ohio law.
              </p>
          ...
          <div className="grid items-start gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="text-muted-foreground">
                Our healthcare notarization process is built to respect patient privacy and meet every Ohio
                statutory requirement. We coordinate with facility staff and follow all credentialing protocols.
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <BedDouble className="mx-auto mb-4 h-12 w-12 text-primary" />
          <h2 className="mb-4 font-sans text-3xl font-bold text-foreground">Need a Notary at Your Facility?</h2>
          <p className="mx-auto mb-8 max-w-lg text-muted-foreground">
            We work with hospital administration, social workers, and nursing staff to coordinate
            bedside notarization visits. Contact us to set up a facility account or schedule a visit.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link to="/book">
              <Button size="lg" className="rounded-full px-8">Book a Bedside Visit</Button>
            </Link>
            <a href="tel:6143006890">
              <Button size="lg" variant="outline">
                <Phone className="mr-2 h-4 w-4" /> Call (614) 300-6890
              </Button>
            </a>
          </div>
        </div>
