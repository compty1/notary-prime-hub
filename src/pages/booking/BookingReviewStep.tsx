    ...
    <div className="space-y-4">
      ...
      {!props.user && (
        <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-3">
          ...
          <div>
            <Label>Email</Label>
            <Input type="email" value={props.guestEmail} onChange={e = autoComplete="email"> props.setGuestEmail(e.target.value)} placeholder="your@email.com" autoComplete="email" className={props.validationErrors?.guestEmail ? "border-destructive" : ""} />
