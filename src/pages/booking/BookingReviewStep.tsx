...
export default function BookingReviewStep(props: ReviewStepProps) {
 ...
 <div>
 <Label>Email</Label>
 <Input type="email" value={props.guestEmail} onChange={(e) => props.setGuestEmail(e.target.value)} autoComplete="email" placeholder="your@email.com" className={props.validationErrors?.guestEmail ? "border-destructive" : ""} />
