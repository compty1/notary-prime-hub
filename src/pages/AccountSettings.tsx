            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <div className="px-6 pb-2">
                  ...
                  <Input id="deletePassword" type="password" value={deletePassword} onChange={(e) => { setDeletePassword(e.target.value); setDeletePasswordError(""); }} autoComplete="current-password" placeholder="Your current password" className="mt-1" />
