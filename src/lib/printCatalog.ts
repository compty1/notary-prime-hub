...
export const PRINT_PRODUCTS: PrintProduct[] = [
  ...
  // Books & Publishing
  { name: "Softcover Books", category: "books", description: "Perfect-bound softcover books with full-color covers", base_price: 4.99, price_tiers: [{ qty: 25, price: 4.99 }, { qty: 50, price: 3.99 }, { qty: 100, price: 2.99 }], options: [{ name: "Size", values: ["5.5x8.5", "6x9", "8.5x11"] }, { name: "Pages", values: ["24–60", "61–120", "121–200", "201–400"] }, { name: "Interior", values: ["B&W", "Full Color"] }], min_quantity: 25, turnaround_days: 10, sort_order: 80 },
  { name: "Hardcover Books", category: "books", description: "Case-bound hardcover books with dust jacket option", base_price: 12.99, price_tiers: [{ qty: 10, price: 12.99 }, { qty: 25, price: 9.99 }, { qty: 50, price: 7.99 }], options: [{ name: "Size", values: ["6x9", "8.5x11", "8x10"] }, { name: "Cover", values: ["Printed Case", "Cloth", "Leather"] }, { name: "Dust Jacket", values: ["None", "Glossy", "Matte"] }], min_quantity: 10, turnaround_days: 14, sort_order: 81 },
  { name: "Coffee Table Books", category: "books", description: "Large-format premium photo books with lay-flat binding", base_price: 29.99, price_tiers: [{ qty: 5, price: 29.99 }, { qty: 10, price: 24.99 }, { qty: 25, price: 19.99 }], options: [{ name: "Size", values: ["10x10", "11x14", "12x12"] }, { name: "Paper", values: ["Satin", "Glossy", "Lustre"] }], min_quantity: 5, turnaround_days: 14, sort_order: 82 },
  { name: "Self-Publishing Package", category: "books", description: "Complete self-publishing: ISBN, formatting, cover design, and print-on-demand setup", base_price: 299.99, price_tiers: [{ qty: 1, price: 299.99 }], options: [{ name: "Format", values: ["Softcover Only", "Hardcover Only", "Both Formats"] }, { name: "Distribution", values: ["Print Only", "Print + eBook"] }], min_quantity: 1, turnaround_days: 21, sort_order: 83 },
  { name: "Booklets & Catalogs", category: "books", description: "Saddle-stitched or perfect-bound booklets and catalogs", base_price: 1.49, price_tiers: [{ qty: 50, price: 1.49 }, { qty: 100, price: 1.19 }, { qty: 250, price: 0.89 }], options: [{ name: "Size", values: ["5.5x8.5", "8.5x11"] }, { name: "Binding", values: ["Saddle-Stitch", "Perfect Bound"] }], min_quantity: 50, turnaround_days: 7, sort_order: 84 },

  // Notebooks & Pads
  { name: "Custom Branded Notebooks", category: "notebooks", description: "Wire-bound or perfect-bound branded notebooks", base_price: 5.99, price_tiers: [{ qty: 25, price: 5.99 }, { qty: 50, price: 4.49 }, { qty: 100, price: 3.49 }], options: [{ name: "Size", values: ["5x7", "6x9", "8.5x11"] }, { name: "Binding", values: ["Wire-O", "Perfect Bound", "Spiral"] }, { name: "Pages", values: ["50", "100", "200"] }], min_quantity: 25, turnaround_days: 7, sort_order: 90 },
  { name: "Memo Pads", category: "notebooks", description: "Custom 4x6 memo pads with company branding, 50 sheets", base_price: 2.99, price_tiers: [{ qty: 25, price: 2.99 }, { qty: 50, price: 2.49 }, { qty: 100, price: 1.99 }], options: [{ name: "Ruling", values: ["Blank", "Lined", "Grid"] }], min_quantity: 25, turnaround_days: 5, sort_order: 91 },
  { name: "Custom Post-It Notes", category: "notebooks", description: "Branded sticky notes with logo, 3x3 or 4x6 sizes", base_price: 1.99, price_tiers: [{ qty: 50, price: 1.99 }, { qty: 100, price: 1.49 }, { qty: 250, price: 0.99 }], options: [{ name: "Size", values: ["3x3", "4x4", "4x6"] }, { name: "Sheets", values: ["25", "50", "100"] }], min_quantity: 50, turnaround_days: 7, sort_order: 92 },
  { name: "Desk Pads & Planners", category: "notebooks", description: "Custom weekly/monthly desk planners with tear-off sheets", base_price: 6.99, price_tiers: [{ qty: 10, price: 6.99 }, { qty: 25, price: 5.49 }], options: [{ name: "Format", values: ["Weekly", "Monthly", "Daily"] }, { name: "Size", values: ["8.5x11", "11x17"] }], min_quantity: 10, turnaround_days: 7, sort_order: 93 },

  // Stickers & Decals
  { name: "Sticker Sheets", category: "stickers", description: "Custom kiss-cut sticker sheets with multiple designs", base_price: 2.99, price_tiers: [{ qty: 25, price: 2.99 }, { qty: 50, price: 2.49 }, { qty: 100, price: 1.99 }], options: [{ name: "Size", values: ["4x6 Sheet", "8.5x11 Sheet"] }, { name: "Material", values: ["Paper", "Vinyl", "Clear Vinyl"] }, { name: "Finish", values: ["Gloss", "Matte", "Holographic"] }], min_quantity: 25, turnaround_days: 5, sort_order: 100 },
  { name: "Bumper Stickers", category: "stickers", description: "Weather-resistant vinyl bumper stickers", base_price: 1.49, price_tiers: [{ qty: 50, price: 1.49 }, { qty: 100, price: 0.99 }, { qty: 250, price: 0.69 }], options: [{ name: "Size", values: ["3x10", "4x8", "3x11.5"] }, { name: "Finish", values: ["Gloss", "Matte"] }], min_quantity: 50, turnaround_days: 5, sort_order: 101 },
  { name: "Floor Decals", category: "stickers", description: "Anti-slip floor graphics for office or event branding", base_price: 9.99, price_tiers: [{ qty: 5, price: 9.99 }, { qty: 10, price: 7.99 }, { qty: 25, price: 5.99 }], options: [{ name: "Shape", values: ["Circle", "Rectangle", "Custom"] }, { name: "Size", values: ["12 inch", "18 inch", "24 inch"] }], min_quantity: 5, turnaround_days: 5, sort_order: 102 },
  { name: "Vehicle Magnets", category: "stickers", description: "Removable magnetic signs for cars and trucks", base_price: 24.99, price_tiers: [{ qty: 1, price: 24.99 }, { qty: 2, price: 19.99 }], options: [{ name: "Size", values: ["12x18", "12x24", "18x24"] }, { name: "Corners", values: ["Square", "Rounded"] }], min_quantity: 1, turnaround_days: 5, sort_order: 103 },

  // Newsletters & Magazines
  { name: "Newsletters", category: "newsletters", description: "Full-color printed newsletters for clients or teams", base_price: 0.45, price_tiers: [{ qty: 100, price: 0.45 }, { qty: 250, price: 0.35 }, { qty: 500, price: 0.25 }], options: [{ name: "Pages", values: ["4", "8", "12", "16"] }, { name: "Size", values: ["8.5x11", "11x17 Folded"] }, { name: "Paper", values: ["60lb Uncoated", "80lb Gloss"] }], min_quantity: 100, turnaround_days: 5, sort_order: 110 },
  { name: "Magazines", category: "newsletters", description: "Professional magazine printing with perfect binding", base_price: 2.99, price_tiers: [{ qty: 50, price: 2.99 }, { qty: 100, price: 2.29 }, { qty: 250, price: 1.79 }], options: [{ name: "Pages", values: ["24–48", "49–96", "97–200"] }, { name: "Size", values: ["8.5x11", "5.5x8.5"] }, { name: "Cover", values: ["Self-Cover", "Plus Cover (Heavier)"] }], min_quantity: 50, turnaround_days: 10, sort_order: 111 },

  // Custom Packaging (expanding existing category)
  { name: "Custom Tissue Paper", category: "packaging", description: "Branded tissue paper for premium packaging", base_price: 0.35, price_tiers: [{ qty: 500, price: 0.35 }, { qty: 1000, price: 0.25 }], options: [{ name: "Color", values: ["White + Logo", "Full Color Print"] }], min_quantity: 500, turnaround_days: 10, sort_order: 63 },
  { name: "Custom Tape", category: "packaging", description: "Branded packing tape with company logo", base_price: 8.99, price_tiers: [{ qty: 12, price: 8.99 }, { qty: 36, price: 6.99 }], options: [{ name: "Width", values: ["2 inch", "3 inch"] }, { name: "Colors", values: ["1 Color", "2 Color", "Full Color"] }], min_quantity: 12, turnaround_days: 10, sort_order: 64 },
  { name: "Gift Bags (Custom)", category: "packaging", description: "Custom printed gift bags for client appreciation", base_price: 1.99, price_tiers: [{ qty: 50, price: 1.99 }, { qty: 100, price: 1.49 }, { qty: 250, price: 0.99 }], options: [{ name: "Size", values: ["Small (5x8)", "Medium (8x10)", "Large (10x13)"] }, { name: "Material", values: ["Paper", "Kraft", "Non-Woven"] }], min_quantity: 50, turnaround_days: 7, sort_order: 65 },
  { name: "Custom Poly Mailers", category: "packaging", description: "Branded poly mailer bags for shipping documents", base_price: 0.25, price_tiers: [{ qty: 100, price: 0.25 }, { qty: 250, price: 0.18 }, { qty: 500, price: 0.14 }], options: [{ name: "Size", values: ["6x9", "10x13", "12x15.5", "14.5x19"] }], min_quantity: 100, turnaround_days: 10, sort_order: 66 },

  // Guides, Manuals & Training Books
  { name: "Guides & Manuals", category: "books", description: "Spiral/wire-o/comb-bound training manuals and reference guides with tabbed dividers", base_price: 5.96, price_tiers: [{ qty: 25, price: 5.96 }, { qty: 50, price: 7.98 }, { qty: 100, price: 7.49 }], options: [{ name: "Binding", values: ["Comb", "Wire-O", "Spiral", "3-Ring"] }, { name: "Cover", values: ["Card Stock", "Laminated"] }, { name: "Pages", values: ["50", "100", "150", "200"] }], min_quantity: 25, turnaround_days: 7, sort_order: 85 },
  { name: "Novels & Creative Writing", category: "books", description: "Professional novel printing for self-published authors with ISBN and barcode options", base_price: 19.99, price_tiers: [{ qty: 1, price: 19.99 }, { qty: 50, price: 6.98 }, { qty: 100, price: 6.49 }], options: [{ name: "Trim", values: ["5.5x8.5", "6x9"] }, { name: "Paper", values: ["Cream 60lb", "White 60lb"] }, { name: "Add-Ons", values: ["None", "ISBN + Barcode", "ISBN + Amazon Listing"] }], min_quantity: 1, turnaround_days: 10, sort_order: 86 },

  // Calendars & Posters
  { name: "Wall Calendars", category: "marketing", description: "Custom wall calendars with 12 monthly photos, coil or saddle-stitch bound", base_price: 7.96, price_tiers: [{ qty: 25, price: 7.96 }, { qty: 50, price: 7.98 }, { qty: 100, price: 6.99 }], options: [{ name: "Size", values: ["8.5x11", "11x17"] }, { name: "Binding", values: ["Saddle-Stitch", "Coil Bound"] }, { name: "Paper", values: ["80lb Gloss", "100lb Gloss"] }], min_quantity: 25, turnaround_days: 7, sort_order: 25 },
  { name: "Posters", category: "signage", description: "Full-color posters on heavy paper or foam board with optional lamination", base_price: 4.90, price_tiers: [{ qty: 10, price: 4.90 }, { qty: 25, price: 5.96 }, { qty: 10, price: 19.90 }], options: [{ name: "Size", values: ["18x24", "24x36"] }, { name: "Material", values: ["Heavy Paper", "Cardstock Laminated", "Foam Board Mounted"] }], min_quantity: 10, turnaround_days: 3, sort_order: 34 },

  // Die-Cut Vinyl Stickers (detailed from doc)
  { name: "Die-Cut Vinyl Stickers", category: "stickers", description: "Premium weatherproof vinyl stickers die-cut to any shape, UV-protected and scratch-resistant", base_price: 0.39, price_tiers: [{ qty: 100, price: 0.39 }, { qty: 250, price: 0.28 }, { qty: 500, price: 0.26 }, { qty: 1000, price: 0.15 }], options: [{ name: "Size", values: ["2x2", "3x3", "4x4", "5x5", "Custom"] }, { name: "Shape", values: ["Circle", "Square", "Oval", "Custom Contour"] }, { name: "Finish", values: ["Gloss", "Matte", "Holographic", "Transparent"] }], min_quantity: 100, turnaround_days: 5, sort_order: 104 },

  // Stationery Sets
  { name: "Stationery Set", category: "stationery", description: "Matching letterhead + #10 envelopes + business cards — cohesive brand suite", base_price: 99.00, price_tiers: [{ qty: 1, price: 99.00 }, { qty: 1, price: 229.00 }, { qty: 1, price: 399.00 }], options: [{ name: "Tier", values: ["Basic (250ea)", "Standard (500ea + cards)", "Premium (1000ea + premium cards)"] }], min_quantity: 1, turnaround_days: 5, sort_order: 14 },
];
