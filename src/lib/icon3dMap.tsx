...
export const CATEGORY_3D_ICON: Record<string, string> = {
  ...
  recurring: receipt,
  consulting: teamReview,
  business_services: workflow,
  research: docSearch,
  technical_support: tools,
  ux_testing: analytics,
};

// Maps individual service icon names to 3D assets for service cards
export const SERVICE_ICON_3D: Record<string, string> = {
  Monitor: videoCall,
  MapPin: notaryAgent,
  Users: teamReview,
  FileText: checklist,
