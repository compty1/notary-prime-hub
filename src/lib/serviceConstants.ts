...
/** L-08: Maps service keywords to notarial act type — priority-ordered (longer/exact matches first) */
export const NOTARIAL_ACT_MAP: [string, string][] = [
  // Exact multi-word matches first (highest priority)
