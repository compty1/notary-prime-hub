...
export const SERVICE_REGISTRY: ServiceRegistryEntry[] = [
  ...
  // Translation & Language
  {
    ...
    slug: "standard-translation",
    category: "translation",
    description: "Professional document translation for personal and business use",
    path: "/request",
    requiredFields: ["fullName", "email", "sourceLanguage", "targetLanguage", "documentDescription"],
    tags: ["remote", "rush-available"],
  ...
  },
  {
    ...
    category: "translation",
    description: "Certified translation with statement of accuracy for official use",
    path: "/request",
    requiredFields: ["fullName", "email", "sourceLanguage", "targetLanguage", "documentDescription"],
    tags: ["remote", "rush-available"],
    requiresNotary: false, ronAvailable: false, idRequired: false, estimatedDuration: 90,
  },
  {
    id: "court-certified-translation",
    name: "Court-Certified Translation",
    slug: "court-certified-translation",
    category: "translation",
    description: "Translation with court-accepted certification for legal proceedings",
    path: "/request",
    requiredFields: ["fullName", "email", "sourceLanguage", "targetLanguage", "courtName", "caseNumber"],
    tags: ["remote", "rush-available"],
  ...
  },
  {
    ...
    category: "translation",
    description: "Foreign credential evaluation for employment or education",
    path: "/request",
    requiredFields: ["fullName", "email", "countryOfOrigin", "credentialType"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: true, estimatedDuration: 120,
  },
  // Business & Volume
  {
    id: "business-subscriptions",
    name: "Business Subscription Plans",
    slug: "business-subscription-plans",
    category: "business",
    description: "Volume pricing and recurring service packages for businesses",
    path: "/subscribe",
    requiredFields: ["fullName", "email", "businessName"],
    tags: ["remote", "subscription"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    id: "api-integration",
    ...
    category: "business",
    description: "Custom API integration for high-volume notarization workflows",
    path: "/request",
    requiredFields: ["fullName", "email", "businessName", "volumeEstimate"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    slug: "white-label-partner-programs",
    category: "business",
    description: "Branded notarization services under your company name",
    path: "/request",
    requiredFields: ["fullName", "email", "businessName"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  ...
  // Consulting & Training
  {
    id: "ron-onboarding-consulting",
    name: "RON Onboarding Consulting",
    slug: "ron-onboarding-consulting",
    category: "consulting",
    description: "One-on-one consulting to set up your RON practice",
    path: "/request",
  ...
  {
    id: "workflow-audit",
    name: "Workflow Audit & Automation",
    slug: "workflow-audit-automation",
    category: "consulting",
    description: "Analyze and optimize your notary business workflows",
    path: "/request",
    requiredFields: ["fullName", "email", "businessName"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false, estimatedDuration: 90,
  ...
  {
    id: "email-management",
    name: "Email Management & Correspondence",
    slug: "email-management--correspondence",
    category: "business_services",
    description: "Professional email management and client correspondence",
    path: "/request",
    requiredFields: ["fullName", "email"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    slug: "registered-agent-coordination",
    category: "business_services",
    description: "Statutory agent services for Ohio business entities",
    path: "/request",
  ...
  // Administrative Support
  {
    ...
    description: "Professional data entry and database management services",
    path: "/request",
  ...
  },
  {
    ...
    category: "admin_support",
    description: "Travel planning and coordination for business trips",
    path: "/request",
    requiredFields: ["fullName", "email"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  ...
  // Content Creation
  {
    ...
    description: "Professional blog content for your notary or business website",
    path: "/request",
    requiredFields: ["fullName", "email", "topicDescription"],
    tags: ["remote", "rush-available"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    category: "content_creation",
    description: "Engaging social media posts and graphics for your business",
    path: "/request",
    requiredFields: ["fullName", "email", "platforms"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    category: "content_creation",
    description: "Custom newsletter templates and content creation",
    path: "/request",
    requiredFields: ["fullName", "email"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  ...
  // Research
  {
    ...
    path: "/request",
    requiredFields: ["fullName", "email", "industry", "researchScope"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    category: "research",
    description: "Targeted lead generation and prospect list building",
    path: "/request",
    requiredFields: ["fullName", "email", "targetMarket"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  // Customer Service
  {
    id: "email-support",
    name: "Email Support Handling",
    slug: "email-support-handling",
    category: "customer_service",
    description: "Professional email support for your clients",
    path: "/request",
    requiredFields: ["fullName", "email", "businessName"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  {
    ...
    category: "customer_service",
    description: "Real-time chat support for your business website",
    path: "/request",
    requiredFields: ["fullName", "email", "businessName"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  ...
  // Technical Support
  {
    ...
    description: "Website content management and update services",
    path: "/request",
    requiredFields: ["fullName", "email", "websiteUrl"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false,
  },
  // UX Services
  {
    id: "ux-audit",
    name: "UX Audit & Heuristic Review",
    slug: "ux-audit--heuristic-review",
    category: "ux_testing",
    description: "Comprehensive UX audit with actionable improvement recommendations",
    path: "/request",
    requiredFields: ["fullName", "email", "websiteUrl"],
    tags: ["remote"],
    requiresNotary: false, ronAvailable: false, idRequired: false, estimatedDuration: 120,
