...
Deno.serve(async (req) => {
  ...
  try {
    // Auth check — try user session, fall back to anon key validation
    ...
    // Validate user session and require admin role (Gap 153)
    ...
    // Restrict build-analyst to admin users only
